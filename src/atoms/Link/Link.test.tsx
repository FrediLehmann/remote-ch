...
describe('<Link />', () => {
  it('renders correctly minimal props', () => {
    ...
    expect(screen.getByRole('link')).to.have.property('href', 'http://google.com/')
  })

  it('renders correctly with props', () => {
    render(<Link href='http://google.com/' hreflang='en-US' rel='noreferrer' target='_blank'>Google</Link>)
  ...
  it('renders correctly as external', () => {
    const {container} = render(<Link href='http://google.com/' external>Google</Link>)
  ...
  it('renders correctly as external and rel', () => {
    render(<Link href='http://google.com/' rel='noreferrer' external>Google</Link>)
